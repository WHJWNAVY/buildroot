...
```diff
From eca68ba6ebc34b723d3eb5034d3bda3e7c350ebe Mon Sep 17 00:00:00 2001
From: Haijun Wang <haijun.wang@hyku.com>
Date: Tue, 7 Jul 2020 13:35:53 +0800
Subject: [PATCH] update freescale_imx28evk_defconfig

---
 configs/freescale_imx28evk_defconfig | 4109 +++++++++++++++++++++++++++++++++-
 1 file changed, 4089 insertions(+), 20 deletions(-)

diff --git a/configs/freescale_imx28evk_defconfig b/configs/freescale_imx28evk_defconfig
index b45e978..485ff5f 100644
...
+BR2_LZCAT="lzip -d -c"
+BR2_TAR_OPTIONS=""
+BR2_DEFCONFIG="/home/mercku/work/arm_linux/my_buildroot/configs/freescale_imx28evk_defconfig"
...
+BR2_TOOLCHAIN_EXTERNAL_PATH="/home/mercku/work/arm_linux/toolchain/arm-926ejs-linux-gnueabi"
...
+
+#
+# rpi-userland needs a toolchain w/ C++, threads, dynamic library
+#
...
+
+#
+# openjdk does not support soft float configurations
+#
...
+
+#
+# c-capnproto needs host and target gcc >= 5 w/ C++14, threads, atomic
+#
+
+#
+# capnproto needs host and target gcc >= 5 w/ C++14, threads, atomic
+#
+
+#
